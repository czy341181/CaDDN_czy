...
def random_flip_horizontal(image, depth_map, gt_bbox3d, gt_bbox2d, calib):
    """
    ...
    if enable:
        ...
        aug_gt_bbox3d = copy.copy(gt_bbox3d)
        aug_gt_bbox2d = copy.copy(gt_bbox2d)
        locations = aug_gt_bbox3d[:, :3]
        ...
        aug_gt_bbox3d[:, :3] = pts_lidar
        aug_gt_bbox3d[:, 6] = -1 * aug_gt_bbox3d[:, 6]

        # Flip 2D gt_boxes by flipping in image space
        aug_gt_bbox2d[:, 0], aug_gt_bbox2d[:, 2] = W - aug_gt_bbox2d[:, 2], W - aug_gt_bbox2d[:, 0]
    else:
        aug_image = image
        aug_depth_map = depth_map
        aug_gt_bbox3d = gt_bbox3d
        aug_gt_bbox2d = gt_bbox2d

    return aug_image, aug_depth_map, aug_gt_bbox3d, aug_gt_bbox2d
