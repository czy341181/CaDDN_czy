...
class FrustumToVoxel(nn.Module):
    ...
    def __init__(self, model_cfg):
        ...
        """
        super().__init__()
        #model_cfg = edict({'NAME': 'FrustumToVoxel', 'SAMPLER': {'mode': 'bilinear', 'padding_mode': 'zeros'}})
        self.model_cfg = model_cfg['frustum_to_voxel']
        self.grid_size = np.array(model_cfg['grid_size'])
        self.pc_range = np.array(model_cfg['pc_range'])
        ...
        self.sampler = Sampler(**self.model_cfg['SAMPLER'])
